"""Structured JSON logging for the Umbra backend.

GitHub Actions captures stdout — structured JSON lines make
heartbeat failures searchable and parseable.

Mirrored from Flux (the-dreaming-repo) as a dependency of respond.py.
Kept byte-for-byte compatible so the two backends log in the same shape.
"""
